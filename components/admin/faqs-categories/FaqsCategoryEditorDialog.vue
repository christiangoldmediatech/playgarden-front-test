            ...
            <v-form @submit.prevent="passes(save)">
              ...
              >
                <file-uploader
                  ...
                  mode="image"
                  path="faq-category"
                  placeholder="Select an icon for this FAQ category"
...
export default {
  ...
  computed: {
    title () {
      return this.id === null ? 'New FAQ Category' : 'Edit FAQ Category'
    }
  },
  ...
  methods: {
    ...
    async save () {
      ...
      try {
        ...
        if (this.id === null) {
          await this.createFAQsCategory(this.item)
        } else {
          await this.updateFAQsCategory({ id: this.id, data: this.item })
        }
