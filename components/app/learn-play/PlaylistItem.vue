      ...
      <v-row no-gutters>
        ...
        <v-col cols="auto" align-self="center">
          ...
          <v-btn
            ...
            icon
            data-test-id="playlist-item-favorite-button"
          ...
          <!-- REMOVE BUTTON -->
          <v-btn
            class="ml-n1 ml-md-0 red--text text--lighten-1"
            icon
            data-test-id="playlist-item-remove-button"
...
export default defineComponent({
  ...
  setup(props) {
    const favoriteButtonClasses = computed(() =>
      props.song?.isFavorite ? 'pink--text text--lighten-2' : ''
    )
