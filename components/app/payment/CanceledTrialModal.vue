  ...
  <div>
    ...
    >
      ...
      <div class="grey--text text--darken-2 caption text-md-h6 font-weight-regular my-3 my-md-6">
        <p>
          Now you are on the <span class="font-weight-bold accent--text"> {{ plan }}</span> plan, we hope your little one enjoys it a lot. As always, you cancel your enrollment anytime by going to your Account Page.
