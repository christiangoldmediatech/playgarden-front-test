...
export default defineComponent({
  ...
  setup() {
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text:
              '<p>Playgarden Prep\'s online preschool is a premier online preschool program offering children 2-4 years old a private preschool experience at home! The Online Preschool program offers a private preschool curriculum, lessons with certified teachers, hands-on learning tools, and a daily learning schedule. You can sign up for your free trial <a href="https://playgardenonline.com/school/auth/normal/parent">here</a>.</p>'
          }
        },
        {
          '@type': 'Question',
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text:
              '<p>Absolutely! Playgarden Prep’s online preschool follows the same curriculum as our elite and award winning preschools in New York City. Your little one will learn from the same teachers that teach at our in-person schools, using the same worksheets and educational tools. With technology, our goal is to make sure that children can have access to a real, effective learning experience at home. Check out some of our <a href="https://playgardenonline.com/testimonials/">parent testimonials</a> that highlight how well their children are doing while learning with Playgarden Prep Online!</p>'
          }
        },
        {
          '@type': 'Question',
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text:
              "<p>Absolutely! Our program has been developed so that you can start it when it's most convenient for your family. Your little one will get started with their first day of class on our platform, and will continue to learn and grow as they progress through the program. Our virtual preschool live classes are meant to complement the daily learning from our lesson videos and worksheets, and to provide a place for little ones to socialize and interact with their teachers. You can access Playgarden Prep’s online preschool program from any desktop, tablet, or smartphone device— anywhere in the world! We are also working to make our lesson videos available for download, so that you can watch them even without a Wifi connection!</p>"
          }
        },
        {
          '@type': 'Question',
        ...
        },
        {
          '@type': 'Question',
          name:
            'Does my child get a certificate for completing the online preschool program?',
          acceptedAnswer: {
            '@type': 'Answer',
            text:
              "<p>Absolutely! We love celebrating accomplishments. Our workbooks provide Diplomas for every letter learned and every month of work completed. We also provide a Certificate for having completed the whole school year of preschool online, using the uploaded worksheets and progress reports from your Student Cubby as evidence of your little one's hard work.</p>"
          }
        }
      ]
    }
    ...
    useMeta({
      script: [
        { innerHTML: JSON.stringify(faqQuestions), type: 'application/ld+json' }
      ]
    })
